...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.n_pay'
        db.add_column('website_payment', 'n_pay', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.n_pay'
        db.delete_column('website_payment', 'n_pay')
