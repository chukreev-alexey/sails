...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('website_payment', 'payment_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payments', null=True, to=orm['website.PaymentType'], blank=True), keep_default=False)
