...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_payment', 'payment_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='payments', null=True, to=orm['website.PaymentType']), keep_default=False)
