...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Payment.checked'
        db.delete_column('website_payment', 'checked')

        # Adding field 'Payment.checked_by'
        db.add_column('website_payment', 'checked_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkers', null=True, to=orm['website.Staff']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Payment.checked'
        db.add_column('website_payment', 'checked', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'Payment.checked_by'
        db.delete_column('website_payment', 'checked_by_id')
